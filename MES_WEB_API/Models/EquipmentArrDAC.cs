...
values(@PRODUCT_ID,@PROCESS_ID,@STEP_ID,@EQP_ID,@TACT_TIME,@PROC_TIME,@EFF_START_DATE,@EFF_END_DATE,@MODIFIER,@MODIFIER_DATE)";
        ...
        {
            string sql = @"update EQP_ARRANGE set TACT_TIME=@TACT_TIME,PROC_TIME=@PROC_TIME,EFF_START_DATE=@EFF_START_DATE,EFF_END_DATE=@EFF_END_DATE,MODIFIER=@MODIFIER,MODIFIER_DATE=@MODIFIER_DATE
where PRODUCT_ID=@PRODUCT_ID and  STEP_ID=@STEP_ID and EQP_ID=@EQP_ID and PROCESS_ID=@PROCESS_ID";
